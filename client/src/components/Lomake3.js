  ...
  return (
      <div className="Lomake3">
        ...
        <Form>
          ...
          <Form.Text className="text-muted">Tämä tieto näkyy ilmoituksessa.</Form.Text>
          </Form.Group>
          <br />
          <Form.Group>
            <Form.Label>Mitkä ovat työntekijän keskeiset tehtävät? <a>(Vinkki)</a></Form.Label>
            <Editor wrapperClassName="wrapper" editorClassName="editor" toolbarClassName="toolbar" />
            <Form.Text className="text-muted">Tämä tieto näkyy ilmoituksessa.</Form.Text>
          </Form.Group>
          <br />
          <Form.Group>
            <Form.Label>Mitä osaamista tarvitaan tehtävän suorittamiseksi? <a>(Vinkki)</a></Form.Label>
            <Editor wrapperClassName="wrapper" editorClassName="editor" toolbarClassName="toolbar" />
            <Form.Text className="text-muted">Tämä tieto näkyy ilmoituksessa.</Form.Text>
          </Form.Group>
          <br />
          <Form.Group>
            <Form.Label>Mitä osaamista itse tarvitset muuttuvaan tilanteeseen? <a>(Vinkki)</a></Form.Label>
            <Editor wrapperClassName="wrapper" editorClassName="editor" toolbarClassName="toolbar" />
            <Form.Text className="text-muted">Tämä tieto näkyy ilmoituksessa.</Form.Text>
          </Form.Group>
          <br />
