                ...
                <Form.Group id="textbox1">
                    ...
                    <Form.Row> 
                        <Col>
                            ...
                            <Form.Control type="text" placeholder="field1" onChange={handleChangeField1}/>
                        </Col>

                        <Col>
                            <Form.Label>Lorem ipsum dolor sit?</Form.Label>
                            <Form.Control type="text" placeholder="field2" onChange={handleChangeField2}/>
                        </Col>
                    </Form.Row>  
                    ...
                    <Form.Row> 
                        <Col>
                            <Form.Label>Lorem ipsum dolor sit?</Form.Label>
                            <Form.Control type="text" placeholder="field3" onChange={handleChangeField3}/>
                        </Col>

                        <Col>
                            <Form.Label>Lorem ipsum dolor sit?</Form.Label>
                            <Form.Control type="text" placeholder="field4" onChange={handleChangeField4}/>
                        </Col>
                    </Form.Row>  
                    ...
                    <Form.Row>
                        <Col>
                            {/**Voiko valita usean?*/}
                            <Form.Check inline label="Pitkä vaihtoehto" type="checkbox" id="Pitkä vaihtoehto" onChange={handleChangeCheck1}/>
                            <Form.Check inline label="Keskipitkä vaihtoehto" type="checkbox" id="Keskipitkä vaihtoehto" onChange={handleChangeCheck2}/>
                            <Form.Check inline label="Lyhyt vaihtoehto" type="checkbox" id="Lyhyt vaihtoehto" onChange={handleChangeCheck3}/>
                            <Form.Check inline label="Ei vaihtoehtoa" type="checkbox" id="Ei vaihtoehtoa" onChange={handleChangeCheck4}/>
                        </Col>  
                    </Form.Row>
